        ...
        <div className="grid gap-6 max-w-[1200px] mx-auto">
            ...
            <div className="p-8">
              <div className="flex flex-col items-center gap-6">
                ...
                <p className="text-sm text-gray-400">
                  This section helps test user interaction monitoring features like rage clicks and dead clicks.
                </p>
              </div>
            </div>
          </Card>
          ...
          <Card className="bg-[#1B1C2B] border-[#2B2C3B] shadow-lg hover:border-purple-500/20 transition-colors">
            <div className="p-8">
              <div className="flex flex-col items-center gap-6">
                ...
                <PerformanceTests />
                <p className="text-sm text-gray-400">
                  Test performance monitoring with various operations.
                </p>
              </div>
            </div>
          </Card>
          ...
          <Card className="bg-[#1B1C2B] border-[#2B2C3B] shadow-lg hover:border-purple-500/20 transition-colors">
            <div className="p-8">
              <div className="flex flex-col items-center gap-6">
                <h2 className="text-2xl font-semibold text-white flex items-center gap-3">
                  <Bug className="h-7 w-7 text-purple-400" />
                  Random Tests
                </h2>
                <RandomSpans />
                <p className="text-sm text-gray-400">
                  Generate random performance spans and errors.
                </p>
              </div>
            </div>
          </Card>
